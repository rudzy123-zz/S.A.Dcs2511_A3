 ...
 * 
 * @author rudolfmusika
 * This Implementation uses the Problem method to facilitate the states.
 */
public class FarmerProblem extends Problem {
    
        public FarmerProblem() {
            super();
            super.setName("Farmer,Wolf,Goat,Cabbage");
        ...
        private static final String INTRO = 
            ...
            + " that only the farmer can row. "
                + "The farmer can take at most one"
            + " other object besides himself on a crossing, "
                + "but if the wolf is"
            + " ever left with the goat, the wolf will eat the goat; "
                + "similarly,"
            + " if the goat is left with the cabbage, the goat will eat "
            + "the cabbage. Devise a sequence of crossings of the river "
                + "so that all"
